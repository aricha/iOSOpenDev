...
#define CHPropertyDeclare(class, name) static const char *k ## class ## _ ## name = CHStringify(name);
...
#define CHPrimitiveProperty(class, type, getter, setter, default) \
	CHPropertyDeclare(class, getter) \
...
#define CHPropertyHook(class, getter, setter) \
